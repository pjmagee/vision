namespace Vision.Core
{
    ...
    public class RepositoryService : IRepositoryService
    {
        ...
        public async Task<IPaginatedList<RepositoryDto>> GetAsync(string search, int pageIndex = 1, int pageSize = 10)
        {
            var query = context.VcsRepositories.AsQueryable();
        ...
        public async Task<IPaginatedList<RepositoryDto>> GetByVcsIdAsync(Guid vcsId, string search, int pageIndex = 1, int pageSize = 10)
        {
            var query = context.VcsRepositories.Where(repository => repository.VcsId == vcsId);
        ...
        public async Task<IPaginatedList<RepositoryDto>> GetByEcosystemIdAsync(Guid ecoId, string search, int pageIndex = 1, int pageSize = 10)
        {
        ...
        public async Task<IPaginatedList<RepositoryDto>> GetByEcosystemVersionIdAsync(Guid ecoVerId, string search, int pageIndex = 1, int pageSize = 10)
        {
            IQueryable<VcsRepository> repositories = context.VcsRepositories
                .Where(repository => context.Assets.Any(asset => asset.RepositoryId == repository.Id &&

    ...
    public static class NavigationHelper
    {
        ...
        static NavigationHelper()
        {
            NavMenuItems = new[]
            {
                ...
                // new NavMenuItem { Type = NavMenuItemType.Datasource, Match = NavLinkMatch.Prefix, Name = "CI/CD", Route = "/builds",  Icon = "fab fa-fw fa-jenkins" },
                ...
                // new NavMenuItem { Type = NavMenuItemType.Datasource, Match = NavLinkMatch.Prefix, Name = "Security", Route = "/security",  Icon = "fas fa-fw fa-shield-alt" },

                new NavMenuItem { Type = NavMenuItemType.Data, Match = NavLinkMatch.Prefix, Name = "Assets", Route = "/assets",  Icon = "fas fa-fw fa-table" },
                new NavMenuItem { Type = NavMenuItemType.Data, Match = NavLinkMatch.Prefix, Name = "Dependencies", Route = "/dependencies",  Icon = "fas fa-fw fa-table" },

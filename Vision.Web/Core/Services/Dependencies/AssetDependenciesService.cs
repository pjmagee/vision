namespace Vision.Web.Core
{
    ...
    public class AssetDependenciesService
    {
        private readonly VisionDbContext context;

        public AssetDependenciesService(VisionDbContext context)
        {
            this.context = context;
        }

        public async Task<PaginatedList<AssetDependencyDto>> GetByAssetIdAsync(Guid assetId, int pageIndex = 1, int pageSize = 10)
        {
        ...
        public async Task<PaginatedList<AssetDependencyDto>> GetByDependencyIdAsync(Guid dependencyId, int pageIndex = 1, int pageSize = 10)
        {
            var query = context.AssetDependencies

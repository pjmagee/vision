...
namespace Vision.Web.Core
{
    public interface IAssetService
    {
        ...
        Task<IPaginatedList<AssetDto>> GetByRuntimeIdAsync(Guid id, string search, IEnumerable<DependencyKind> kinds, int pageIndex = 1, int pageSize = 10);
        Task<IPaginatedList<AssetDto>> GetByRuntimeVersionIdAsync(Guid id, string search, IEnumerable<DependencyKind> kinds, int pageIndex = 1, int pageSize = 10);
        ...
        Task<IPaginatedList<AssetDto>> GetByAssetIdAsync(Guid id, string search, IEnumerable<DependencyKind> kinds, int pageIndex = 1, int pageSize = 10);
